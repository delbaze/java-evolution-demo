...
public class StreamEnhancementsDemo {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> takenWithJava9 = Arrays.stream(numbers)
                .takeWhile(n -> n % 2 == 0)
                .collect(Collectors.toList());

        System.out.println("RESULTAT avec takeWhile " + takenWithJava9);

        List<Integer> droppedWithJava9 = Arrays.stream(numbers)
                .dropWhile(n -> n % 2 == 0)
                .collect(Collectors.toList());

        System.out.println("RESULTAT avec dropWhile " + droppedWithJava9);
        ...
        Stream<String> streamJava9 = Stream.ofNullable(value);
        System.out.println("Résultat avec une valeur non-null : " + streamJava9.collect(Collectors.toList()));

        String nullValue = getValue(false);
        Stream<String> streamJava9WithNull = Stream.ofNullable(nullValue);
        System.out.println("Résultat avec une valeur null : " + streamJava9WithNull.collect(Collectors.toList()));
        ...
        long countNonNullJava9 = Arrays.stream(arrayWithNulls)
                .flatMap(Stream::ofNullable) // ["Un", [], "Deux", [], "Trois"] => ["Un", "Deux", "Trois"]
                .count();
        System.out.println("Nombre d'éléments non null avec flatMap + ofNullable: " + countNonNullJava9);
